...
class MocktailPage extends StatefulWidget {
  final int id;

  MocktailPage({Key? key, required this.id}) : super(key: key);
  @override
  _MocktailPageState createState() => _MocktailPageState();
}

class _MocktailPageState extends State<MocktailPage> {
  ...
  Future<void> fetchDrinks() async {
    final url = '${Config.url}/minuman/moctail'; // Ganti dengan URL API Anda
